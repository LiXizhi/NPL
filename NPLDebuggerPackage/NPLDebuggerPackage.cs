...
namespace ParaEngine.NPLDebuggerPackage
{
    ...
    //[ProvideToolWindow(typeof(DebuggerToolWindow))]
    [Guid(GuidList.guidNPLDebuggerPackagePkgString)]
    public sealed class NPLDebuggerPackage : Package
    {
        public DTE2 DTE2 { get; set; }

        public NPLDebuggerConnect NPLDebugger;
        ...
        private void ShowToolWindow(object sender, EventArgs e)
        {
            ...
            //ToolWindowPane window = this.FindToolWindow(typeof(DebuggerToolWindow), 0, true);
