...
namespace ParaEngine.NPLLanguageService
{
    ...
    /// </summary>
    [Guid(GuidList.guidNPLLanguageServiceEditorFactoryString)]
    public sealed class EditorFactory : IVsEditorFactory, IDisposable
    {
        private NPLLanguageServicePackage editorPackage;
        private ServiceProvider vsServiceProvider;


        public EditorFactory(NPLLanguageServicePackage package)
        {
                        ...
                        out int pgrfCDW)
        {
            ...
            pguidCmdUI = GuidList.guidNPLLanguageServiceEditorFactory;
            pgrfCDW = 0;
