...
namespace ParaEngine.Tools.Lua.SourceOutliner
{
    ...
    public class SearchCriteria
    {
    	...
    	public CodeElementType ElementFilter { get; set; }
    }
    ...
    /// </summary>
    internal class CodeElementWrapperArrayIndexTable : ICloneable
    {
        protected List<int> list;
        protected CodeElementWrapperArray codeElementWrapperArray;
        ...
        {
            list = new List<int>(copy.list);
            codeElementWrapperArray = copy.codeElementWrapperArray;
        }
        ...
        {
            get { return (codeElementWrapperArray[list[i]]); }
        }
        ...
        /// </summary>
        private class MyComparer : Comparer<int>
        {
            private readonly CodeElementWrapperArray sortArray;
            private readonly SortCriteria criteria;
            ...
            {
            	if (criteria.SortOrder == SortCriteria.SortType.ALPHA)
                {
                    return (String.Compare(sortArray[x].ElementName, sortArray[y].ElementName, true));
                    ...
                    //   return (String.Compare(sortArray[x].CodeElement.Name, sortArray[y].CodeElement.Name, true));
                    //
                    ...
                    //   return (String.Compare(sortArray[x].UniqueElementId, sortArray[y].UniqueElementId, true));
                }

            	return (sortArray[x].Location - sortArray[y].Location);
            }
        }
        ...
        {
            var myComparer = new MyComparer(codeElementWrapperArray, crit);
    ...
    /// </remarks>
    internal class IndexTable : IEnumerable<CodeElementWrapper>
    {
