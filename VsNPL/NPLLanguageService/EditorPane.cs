...
namespace ParaEngine.NPLLanguageService
{
    ...
    //     - An empty npllanguageservice file in the same directory as NewFileItems.vsdir. In
    //       our case we chose lua.npllanguageservice. Note this file name appears in Editor.vsdir
    ...
    //          - "lua" - This is the base file name. New files will initially
    //             be named as lua1.npllanguageservice, lua2.npllanguageservice... etc.
    ///////////////////////////////////////////////////////////////////////////////
    // Editor.vsdir contents:-
    //    lua.npllanguageservice|{3085E1D6-A938-478e-BE49-3546C09A1AB1}|#106|80|#109|0|401|0|#107
    //
    // The fields in order are as follows:-
    //    - lua.npllanguageservice - our empty npllanguageservice file
    ...
    //    - #107 - the ID of "npllanguageservice"
    ///////////////////////////////////////////////////////////////////////////////
                                ...
                                IVsToolboxUser      //Sends notification about Toolbox items to the owner of these items
    {
        ...
        private const string MyExtension = ".npllanguageservice";
        ...
        #region Fields
        private NPLLanguageServicePackage myPackage;
        ...
        public EditorPane(NPLLanguageServicePackage package)
            : base(null)
        {
            PrivateInit(package);
        }
        ...
        /// <summary>
        /// Initialization routine for the Editor. Loads the list of properties for the npllanguageservice document 
        /// which will show up in the properties window 
        /// </summary>
        /// <param name="package"></param>
        private void PrivateInit(NPLLanguageServicePackage package)
        {
            myPackage = package;
            loading = false;
        ...
        private void setupCommands()
        {
            ...
            if (null != mcs)
            {
                ...
                addCommand(mcs, GuidList.guidNPLLanguageServiceCmdSet, (int)PkgCmdIDList.icmdStrike,
        ...
        private void DisplayContextMenuAt(Point point)
        {
            ...
            CommandID contextMenuID = new CommandID(GuidList.guidNPLLanguageServiceCmdSet, PkgCmdIDList.IDMX_RTF);
